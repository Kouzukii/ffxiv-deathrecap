...
public class CombatEventCapture : IDisposable {
    ...
    public CombatEventCapture(DeathRecapPlugin plugin) {
        ...
        receiveActorControlSelfHook = Hook<ReceiveActorControlSelfDelegate>.FromAddress(
            Service.SigScanner.ScanText("E8 ?? ?? ?? ?? 0F B7 0B 83 E9 64"), ReceiveActorControlSelfDetour);
        ...
        actionIntegrityDelegateHook = Hook<ActionIntegrityDelegate>.FromAddress(
                    ...
                    for (var j = 0; j < 8; j++) {
                        ...
                        switch (actionType) {
                            ...
                            case ActionType.Healing:
                                combatEvents.AddEntry(actionTargetId, new CombatEvent.Healed {
