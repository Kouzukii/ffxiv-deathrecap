                ...
                new CombatEvent.Healed {
                    ...
                    Snapshot =
                        new CombatEvent.EventSnapshot {
                            ...
                            MaxHp = 64167,
                            StatusEffects =
                                new List<CombatEvent.StatusEffectSnapshot> {
                                    new() { Id = 360, StackCount = 0 },
                                    new() { Id = 362, StackCount = 0 },
                                    new() { Id = 2604, StackCount = 0 },
                                    new() { Id = 48, StackCount = 0 },
                                    new() { Id = 50, StackCount = 0 },
                                    new() { Id = 2911, StackCount = 0 }
                                }
                        }
                },
                        ...
                        new CombatEvent.EventSnapshot {
                            ...
                            StatusEffects =
                                new List<CombatEvent.StatusEffectSnapshot> {
                                    ...
                                    new() { Id = 2604, StackCount = 0 },
                                    new() { Id = 48, StackCount = 0 },
                                    new() { Id = 1890, StackCount = 0 },
                                    new() { Id = 2911, StackCount = 0 },
                                    new() { Id = 2599, StackCount = 0 },
                                    new() { Id = 1204, StackCount = 0 },
                                    new() { Id = 2600, StackCount = 0 },
                                    new() { Id = 2606, StackCount = 0 },
                                    new() { Id = 1951, StackCount = 0 }
                                }
                        }
                },
                        ...
                        new CombatEvent.EventSnapshot {
                            ...
                            StatusEffects =
                                new List<CombatEvent.StatusEffectSnapshot> {
                                    ...
                                    new() { Id = 2600, StackCount = 0 },
                                    new() { Id = 1951, StackCount = 0 },
                                    new() { Id = 2609, StackCount = 0 },
                                    new() { Id = 1195, StackCount = 0 },
                                    new() { Id = 1193, StackCount = 0 }
                                },
                            BarrierPercent = 19
                        }
                },
                        ...
                        new CombatEvent.EventSnapshot {
                            ...
                            StatusEffects =
                                new List<CombatEvent.StatusEffectSnapshot> {
                                    ...
                                    new() { Id = 2604, StackCount = 0 },
                                    new() { Id = 48, StackCount = 0 },
                                    new() { Id = 2620, StackCount = 0 },
                                    new() { Id = 1879, StackCount = 0 },
                                    new() { Id = 2618, StackCount = 0 },
                                    new() { Id = 2938, StackCount = 0 }
                                }
                        }
                },
                        ...
                        new CombatEvent.EventSnapshot {
                            ...
                            StatusEffects =
                                new List<CombatEvent.StatusEffectSnapshot> {
                                    ...
                                    new() { Id = 2604, StackCount = 0 },
                                    new() { Id = 48, StackCount = 0 },
                                    new() { Id = 2941, StackCount = 0 },
                                    new() { Id = 2620, StackCount = 0 },
                                    new() { Id = 2598, StackCount = 0 },
                                    new() { Id = 2618, StackCount = 0 },
                                    new() { Id = 2938, StackCount = 0 }
                                }
                        }
                        ...
                        new CombatEvent.EventSnapshot {
                            ...
                            StatusEffects =
                                new List<CombatEvent.StatusEffectSnapshot> {
                                    ...
                                    new() { Id = 48, StackCount = 0 },
                                    new() { Id = 3082, StackCount = 0 },
                                    new() { Id = 160, StackCount = 0 },
                                    new() { Id = 2598, StackCount = 0 },
                                    new() { Id = 2643, StackCount = 5 },
                                    new() { Id = 2613, StackCount = 0 },
                                    new() { Id = 2606, StackCount = 0 }
                                },
                            BarrierPercent = 7
                        }
                    ...
                    Snapshot = new CombatEvent.EventSnapshot {
                        ...
                        StatusEffects =
                            new List<CombatEvent.StatusEffectSnapshot> {
                                ...
                                new() { Id = 2643, StackCount = 5 },
                                new() { Id = 2613, StackCount = 0 },
                                new() { Id = 2683, StackCount = 0 },
                                new() { Id = 2684, StackCount = 0 }
                            },
                        BarrierPercent = 7
                    }
                },
                ...
                Events = [
                        ...
                        Snapshot =
                            new CombatEvent.EventSnapshot {
                                ...
                                StatusEffects =
                                    new List<CombatEvent.StatusEffectSnapshot> {
                                        new() { Id = 360, StackCount = 0 },
                                        new() { Id = 364, StackCount = 0 },
                                        new() { Id = 48, StackCount = 0 },
                                        new() { Id = 1204, StackCount = 0 },
                                        new() { Id = 1912, StackCount = 0 },
                                        new() { Id = 297, StackCount = 0 }
                                    },
                                BarrierPercent = 19
                            }
                    },
                    ...
                    new CombatEvent.Healed {
                        ...
                        Snapshot = new CombatEvent.EventSnapshot {
                            ...
                            CurrentHp = 25505,
                            MaxHp = 61202,
                            StatusEffects = new List<CombatEvent.StatusEffectSnapshot> {
                                new() { Id = 360, StackCount = 0 },
                                new() { Id = 364, StackCount = 0 },
                                new() { Id = 48, StackCount = 0 },
                                new() { Id = 315, StackCount = 0 },
